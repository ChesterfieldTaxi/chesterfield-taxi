...
import { CarIcon, LockIcon, MailIcon, UserIcon } from '../components/ui/Icons';

export function meta() {
  return [
    { title: 'Create Account – Chesterfield Taxi' },
    { name: 'description', content: 'Register for a Chesterfield Taxi account' },
  ];
}
